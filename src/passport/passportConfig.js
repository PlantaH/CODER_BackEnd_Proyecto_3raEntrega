...
//Clase contenedora de usuarios y carros
...
passport.use("local-signup", new LocalStrategy({
  ...
  //Valido el usuario
    let usuario = await usuarios.getByUser(username)
    ...
    let userNew = await usuarios.save({email: username, password:hash, nombre, direccion, edad, telefono, avatar, carrito})
    
    //Envio de mail al administrador de la pagina
    const mailOptions = {
      from:"Servidor node.js",
      to: "laplantah@gmail.com",
